...
public class EstatisticasController {
    ...
    public ResponseEntity<EstatisticasResponseDTO> buscarEstatisticas(@RequestParam(
            value = "IntervaloBusca", required = false, defaultValue = "60") Integer intervaloBusca) {
